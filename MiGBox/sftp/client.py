...
class SFTPClient(paramiko.SFTPClient):
    ...
    def connect(cls, host, port, host_key, user_key, username='', password=None):
        """
        ...
        @type port: int
        @param host_key: the path to the host's public key.
        @type host_key: str
        @param user_key: the path to the user's private key.
        @type user_key: str
